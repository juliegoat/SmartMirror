...
$api_endpoint = 'https://api.twitter.com/1.1/search/tweets.json?q=smartmirrorthesis&src=typd&result_type=recent&count=5'; // endpoint must support "Application-only authentication"
